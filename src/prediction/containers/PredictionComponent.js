...
import PlaceVoteComponent from '../components/PlaceVoteComponent';
      ...
      <div className="container">
        ...
        <div className="">
          ...
          <InfoComponent
            ...
            positiveVotesBalance={this.props.positiveVotesBalance}
            negativeVotesBalance={this.props.negativeVotesBalance}
            isOwned={isOwned}
          ...
          { this.props.activeAccountAddress !== undefined &&
            ...
            <ResolveComponent
              ...
              resolvePredictionUsingVotes={this.props.resolvePredictionUsingVotes}
              />
          }
          ...
          { this.props.activeAccountAddress !== undefined &&
            ...
            <PlaceVoteComponent
              isOwned={isOwned}
              placeVote={this.props.placeVote}
              />
          }
          ...
          { this.props.activeAccountAddress !== undefined &&
            <UserInfoComponent
              ...
              voterPositiveBalance={this.props.voterPositiveBalance}
              voterNegativeBalance={this.props.voterNegativeBalance}
            />
          }
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    stopBets: () => dispatch(stopBets()),
    placeVote: (prediction, value) => dispatch(placeVote(prediction, value)),
    resolvePrediction: (outcome) => dispatch(resolvePrediction(outcome)),
    resolvePredictionUsingVotes: (outcome) => dispatch(resolvePredictionUsingVotes(outcome)),
