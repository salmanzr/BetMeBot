...
const InfoComponent = ({
                         ...
                         positiveVotesBalance,
                         negativeVotesBalance,
                         isOwned,
                         predictionState,
                         predictionStateStr,
                         betEndDate,
  ...
  const allvotes = positiveVotesBalance + negativeVotesBalance;
  const posVotePercent = allvotes === 0 ? 0 : 100 * positiveVotesBalance / allvotes;
  const negVotePercent = allvotes === 0 ? 0 : 100 * negativeVotesBalance / allvotes;
    ...
    <div>
      ...
      <div className="progress">
        <div className="progress-bar progress-bar-info" style={{width: `${posPercent}%`}}>
          {posPercent > 5 &&
            <span className="">
              <span className="glyphicon glyphicon-thumbs-up"></span>&nbsp;Bets:
        ...
        <div className="progress-bar progress-bar-danger" style={{width: `${negPercent}%`}}>
          {negPercent > 5 &&
            <span className="">
              <span className="glyphicon glyphicon-thumbs-down"></span>&nbsp;Bets:
      ...
      {balance !== undefined &&
      <div className="progress">
        <div className="progress-bar progress-bar-info" style={{width: `${posVotePercent}%`}}>
          {posVotePercent > 5 &&
            <span className="">
              <span className="glyphicon glyphicon-thumbs-up"></span>&nbsp;Votes:
              {positiveVotesBalance}{ETH_SYMBOL}
            </span>
          }
        </div>
        <div className="progress-bar progress-bar-danger" style={{width: `${negVotePercent}%`}}>
          {negVotePercent > 5 &&
            <span className="">
              <span className="glyphicon glyphicon-thumbs-down"></span>&nbsp;Votes:
              {negativeVotesBalance}{ETH_SYMBOL}
            </span>
          }
        </div>
      </div>
