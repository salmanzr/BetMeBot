...
const UserInfoComponent = ({
  ...
  voterPositiveBalance,
  voterNegativeBalance,
  playerPrizes,
  predictionState,
}) => {
  ...
  return (
    <div className='panel panel-default'>
      ...
      <div className="panel-body">
          ...
          {/* VOTES */}
          { voterPositiveBalance > 0 &&
            <div>
              Votes on yes: {voterPositiveBalance}{ETH_SYMBOL}
            </div>
          }
          { voterNegativeBalance > 0 &&
          <div>
            Votes on no: {voterNegativeBalance}{ETH_SYMBOL}
          </div>
          }
